...
/*   Updated: 2023/01/04 15:45:31 by jiychoi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class User {
	private:
		std::vector<struct pollfd>::iterator	_clientFDIterator; // 클라이언트 소켓 fd
	...
	public:
		...
		std::vector<struct pollfd>::iterator	getSocketFD() const;
		...
		void									setSocketFD(std::vector<struct pollfd>::iterator fdIter);
};
